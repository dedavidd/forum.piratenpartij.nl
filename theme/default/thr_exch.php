...
}function get_host($ip)
{
	...
	if (isset($_GET['appr']) && ($thrx = thx_get((int)$_GET['appr']))) {
		...
		if (!empty($_POST['reason'])) {
			send_status_update($data->id, $data->login, $data->email, 'Het verzoek voor het verplaatsen van  '.$data->subject.' naar het forum '.$data->f2_name.' is afgekeurd.', htmlspecialchars($_POST['reason']));
			thx_delete($thrx->id);
			$decl = 0;
		} else {
...
<tr>
	<td class="RowStyleC">Reden voor het afkeuren van het verzoek om onderwerp <b>'.$data->subject.'</b> naar forum <b>'.$data->f2_name.' te verplaatsen</b><br /><textarea name="reason" cols="60" rows="10"></textarea><br /><input type="submit" class="button" name="btn_submit" value="Opslaan" /></td>
<tr>
</form>';
		}
...
<tr class="RowStyleB">
	<td class="al nw vt SmallText"><b>Verplaatsen onderwerp aangevraagd door:</b> <a href="index.php?t=usrinfo&amp;id='.$obj->req_by.'&amp;'._rsid.'">'.$obj->alias.'</a><br /></td>
	<td class="ac wa vt SmallText"><b>Reden voor verzoek:</b><br /><table border="1" cellspacing="1" cellpadding="0"><tr><td class="al">&nbsp;'.$obj->reason_msg.' &nbsp;</td></tr></table></td>
</tr>
<tr class="RowStyleC">
	<td colspan="2">
		<table border="0" cellspacing="0" cellpadding="3" class="wa">
		<tr>
			<td class="al SmallText"><b>Bronforum:</b> '.$obj->sf_name.'<br /><b>Doelforum:</b> '.$obj->df_name.'<br /><b>Onderwerp:</b> <a href="index.php?t=msg&amp;'._rsid.'&amp;th='.$obj->th.'">'.$obj->subject.'</a></td>
			<td class="ar">[<a href="index.php?t=thr_exch&amp;appr='.$obj->id.'&amp;'._rsid.'">Verzoek goedkeuren</a>]&nbsp;&nbsp;[<a href="index.php?t=thr_exch&amp;decl='.$obj->id.'&amp;'._rsid.'">Verzoek afkeuren</a>]</td>
		</tr>
		</table>
	</td>
</tr>
		...
		if (!$thr_exch_data) {
			$thr_exch_data = '<tr>
	<td class="RowStyleA ac">Er wachten geen verzoeken op goedkeuring.</td>
</tr>';
		} else if ($is_a && $thx) {
