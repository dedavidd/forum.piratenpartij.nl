...
<tr>
	<td class="small">
		Waarom wilt u dit onderwerp laten verplaatsen?<br />
		<textarea name="reason_msg" rows="7" cols="30"></textarea>
	</td>
</tr>
<tr>
	<td class="ar"><input type="submit" class="button" name="submit" value="Aanvraag verzenden" /></td>
</tr>';
		}
	}
	...
	<td style="padding-left: '.$tabw.'px"><a href="index.php?t=mvthread&amp;th='.$thr->id.'&amp;to='.$r[1].'&amp;'._rsid.'&amp;SQ='.$GLOBALS['sq'].'">'.$r[0].'</a></td>
				...
				$table_data .= '<tr>
	<td style="padding-left: '.$tabw.'px">'.$r[0].' [<a href="index.php?t=mvthread&amp;th='.$thr->id.'&amp;'._rsid.'&amp;thx='.$r[1].'&amp;SQ='.$GLOBALS['sq'].'">verplaatsing aanvragen</a>]</td>
</tr>';
			}
		}
		unset($c);
...
<tr>
	<td class="small">Onderwerp <b><?php echo $thr->subject; ?></b> verplaatsen naar:</td>
</tr>
<?php echo $table_data; ?>
</table>
<?php echo _hs; ?>
