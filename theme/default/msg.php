...
* $Id: msg.php.t 5456 2012-04-19 14:12:42Z naudefj $
*
...
function post_to_smiley($text)
{
	...
	$RSS = ($FUD_OPT_2 & 1048576 ? '<link rel="alternate" type="application/rss+xml" title="Dit forum syndiceren (XML)" href="'.$GLOBALS['WWW_ROOT'].'feed.php?mode=m&amp;th='.$th.'&amp;basic=1" />
' : '' )  ;
	...
	if (_uid) {
		...
		*/
		...
		$first_unread_message_link = (($total - $th) > $count) ? '| <a href="index.php?t=msg&amp;unread=1&amp;th='.$th.'&amp;'._rsid.'" title="Naar het eerste ongelezen bericht binnen dit onderwerp gaan">Naar ongelezen berichten gaan</a>&nbsp;' : '';
		$subscribe_status = $frm->subscribed ? '| <a href="index.php?t=msg&amp;th='.$th.'&amp;notify='.$usr->id.'&amp;'._rsid.'&amp;opt=off&amp;start='.$_GET['start'].'&amp;SQ='.$GLOBALS['sq'].'" title="Bij nieuwe berichten in dit onderwerp geen waarschuwingen meer verzenden">Abonnenment op dit onderwerp opheffen</a>&nbsp;' : '| <a href="index.php?t=msg&amp;th='.$th.'&amp;notify='.$usr->id.'&amp;'._rsid.'&amp;opt=on&amp;start='.$_GET['start'].'&amp;SQ='.$GLOBALS['sq'].'" title="Een bericht ontvangen aks er nieuwe berichten in dit onderwerp zijn">Op dit onderwerp abonneren</a>&nbsp;';
		$bookmark_status  = $frm->bookmarked ? '| <a href="index.php?t=msg&amp;th='.$th.'&amp;bookmark='.$usr->id.'&amp;'._rsid.'&amp;opt=off&amp;start='.$_GET['start'].'&amp;SQ='.$GLOBALS['sq'].'" title="Bladwijzer voor dit onderwerp verwijderen">Bladwijzer verwijderen</a>&nbsp;' : '| <a href="index.php?t=msg&amp;th='.$th.'&amp;bookmark='.$usr->id.'&amp;'._rsid.'&amp;opt=on&amp;start='.$_GET['start'].'&amp;SQ='.$GLOBALS['sq'].'" title="Dit onderwerp aan uw bladwijzers toevoegen">Bladwijzer voor onderwerp toevoegen</a>&nbsp;';
	} else {
	...
	ses_update_status($usr->sid, 'Door onderwerp <a href="index.php?t=msg&amp;th='.$frm->id.'">'.$frm->subject.'</a> aan het bladeren', $frm->forum_id);
...
<span id="threadRating"><?php echo ($FUD_OPT_2 & 4096 && $frm->rating ? '&nbsp;('.($MOD ? '<a href="javascript://" onclick="window_open(\''.$GLOBALS['WWW_ROOT'].'index.php?t=ratingtrack&amp;'._rsid.'&amp;th='.$frm->id.'\', \'th_rating_track\', 300, 400);">' : '' )  .'<img src="theme/default/images/'.$frm->rating.'stars.gif" title="'.$frm->rating.' na '.convertPlural($frm->n_rating, array(''.$frm->n_rating.' stem',''.$frm->n_rating.' stemmen')).'" alt=""/>'.($MOD ? '</a>' : '' )  .') '.convertPlural($frm->n_rating, array(''.$frm->n_rating.' stem',''.$frm->n_rating.' stemmen')).'' : ''); ?></span>
...
<b>::</b> <a href="index.php?t=mnav&amp;<?php echo _rsid; ?>" rel="nofollow">Navigatie</a>
	<br />
	<?php echo (($frm->replies && $perms & 2048) ? '<a href="index.php?t=split_th&amp;'._rsid.'&amp;th='.$th.'">Onderwerp splitsen</a>&nbsp;|&nbsp;' : ''); ?>
	<?php echo (($frm->replies && $perms & 8192) ? '<a href="index.php?t=movemsg&amp;th='.$th.'">Berichten verplaatsen</a>&nbsp;|&nbsp;' : ''); ?>
	<?php echo ($perms & 8192 ? '<a href="javascript://" onclick="window_open(\''.$GLOBALS['WWW_ROOT'].'index.php?t=mvthread&amp;'._rsid.'&amp;th='.$th.'\', \'th_move\', 300, 400);">Verplaatsen</a>&nbsp;|&nbsp;' : ''); ?>
	<?php echo ($perms & 4096 ? ($frm->thread_opt & 1 ? '<a href="index.php?t=mmod&amp;'._rsid.'&amp;th='.$th.'&amp;unlock=1&amp;SQ='.$GLOBALS['sq'].'">Onderwerp ontgrendelen</a>&nbsp;|&nbsp;' : '<a href="index.php?t=mmod&amp;'._rsid.'&amp;th='.$th.'&amp;lock=1&amp;SQ='.$GLOBALS['sq'].'">Onderwerp sluiten</a>&nbsp;|&nbsp;'):'').'
	'.($FUD_OPT_2 & 1073741824 ? '<a href="index.php?t=remail&amp;th='.$th.'&amp;'._rsid.'" title="De URL naar deze pagina naar een of meer vrienden zenden via e-mail" rel="nofollow">Vriend e-mailen</a>&nbsp;' : ''); ?>
	<?php echo $first_unread_message_link.$subscribe_status.$bookmark_status; ?>
</td>
<td class="vb ar">
	<?php echo ($FUD_OPT_3 & 2 ? '' : '<a href="index.php?t=tree&amp;th='.$th.'&amp;'._rsid.'"><img title="Onderwerp in boomstructuur weergeven" alt="Onderwerp in boomstructuur weergeven" src="theme/default/images/tree_view.gif" /></a>&nbsp;'); ?><a href="index.php?t=post&amp;frm_id=<?php echo $frm->forum_id; ?>&amp;<?php echo _rsid; ?>"><img alt="Nieuw onderwerp starten" src="theme/default/images/new_thread.gif" /></a><?php echo ((!($frm->thread_opt & 1) || $perms & 4096) ? '&nbsp;<a href="index.php?t=post&amp;th_id='.$th.'&amp;reply_to='.$frm->root_msg_id.'&amp;'._rsid.'&amp;start='.$_GET['start'].'"><img src="theme/default/images/post_reply.gif" alt="Antwoorden" /></a>' : ''); ?>
</td>
</tr>
</table>
...
<tr>
	<td class="MsgSpacer">
		<table cellspacing="0" cellpadding="0" class="MsgTable">
		<tr>
			<td class="MsgR1 fb '.(!$quick_reply_collapsed ? 'MsgSubText' : '' )  .'">
				'.($quick_reply_collapsed ? '<img src="theme/default/images/max'.img_ext.'" alt="+" title="Bericht maximaliseren" class="collapsable" />' : '' )  .'
				Snel antwoorden
			</td>
		</tr>
		<tr>
			<td class="MsgR3" '.($quick_reply_collapsed ? 'style="display:none;"' : '' )  .'>
				<table><tr class="RowStyleA"><td class="GenText nw">Opmaakgereedschappen:</td><td class="nw">
...
<select name="fnt_face" onchange="insertTag(document.post_form.msg_body, \'[font=\'+document.post_form.fnt_face.options[this.selectedIndex].value+\']\', \'[/font]\'); document.post_form.fnt_face.options[0].selected=true">
	...
	<option value="Century" style="font-family:Century">Century</option>
				...
				<textarea wrap="virtual" id="txtb" cols="" rows="" name="msg_body" onkeyup="storeCaret(this);" onclick="storeCaret(this);" onselect="storeCaret(this);" style="width:99%; height:100px;"></textarea>
				'._hs.'
		...
		<tr>
			<td class="MsgToolBar" '.($quick_reply_collapsed ? 'style="display:none;"' : '' )  .'>
				<input type="submit" accesskey="r" class="button" value="Voorvertoning antwoord" tabindex="4" name="preview" />
				<input type="submit" accesskey="s" class="button" tabindex="5" name="btn_submit" value="Snel antwoord plaatsen" onclick="javascript: document.post_form.submitted.value=1;" />
			</td>
		</tr>
		</table>
	</td>
...
<tr>
	...
	<td class="GenText ar vb nw">'.($FUD_OPT_3 & 2 ? '' : '<a href="index.php?t=tree&amp;th='.$th.'&amp;'._rsid.'"><img title="Onderwerp in boomstructuur weergeven" alt="Onderwerp in boomstructuur weergeven" src="theme/default/images/tree_view.gif" /></a>&nbsp;'); ?><a href="index.php?t=post&amp;frm_id=<?php echo $frm->forum_id; ?>&amp;<?php echo _rsid; ?>"><img alt="Nieuw onderwerp starten" src="theme/default/images/new_thread.gif" /></a><?php echo (!$quick_reply_enabled && (!($frm->thread_opt & 1) || $perms & 4096) ? '&nbsp;<a href="index.php?t=post&amp;th_id='.$th.'&amp;reply_to='.$frm->root_msg_id.'&amp;'._rsid.'&amp;start='.$_GET['start'].'"><img src="theme/default/images/post_reply.gif" alt="Antwoorden" /></a>' : ''); ?></td>
</tr>
</table>
...
<select class="SmallText" onchange="if (this.value) topicVote(this.value, '.$frm->id.', \''.s.'\', \''.$usr->sq.'\');">
	<option>Onderwerp beoordelen</option>
	<option value="1">1 Slechtste</option>
	<option value="2">2</option>
	<option value="3">3</option>
	<option value="4">4</option>
	<option value="5">5 Beste</option>
</select>
</form>' : ''); ?>
