...
<div align="center">
<b><?php echo (!empty($_POST['del_sel_all']) ? 'Onderwerpen verwijderen' : 'Onderwerpen verplaatsen'); ?>:</b><br />
...
<input type="submit" name="del_conf" value="Ja" /> 
' : '
...
<input type="submit" name="NO" value="Annuleren" /> 
<input type="hidden" name="mov_sel_all" value="1" />
<input type="submit" name="submit" value="Onderwerpen verplaatsen" /> 
'); ?>
</div>
</form>
