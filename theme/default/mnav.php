...
function trim_body($body)
{
	...
	$TITLE_EXTRA = ': Navigatie';

	ses_update_status($usr->sid, 'Met <a href="index.php?t=mnav">Berichtennavigator</a> door berichten bladeren');
...
<tr>
	<td class="GenTextRed">Voer een geldige periode in. Dit mag een gebroken getal zijn (0.12) maar het moet groter zijn dan nul.</td>
</tr>
</table>
</div>';
	} else if ($unit <= 0) {
...
<table cellspacing="1" cellpadding="2" class="mnavWarnTbl">
<tr>
	<td class="GenTextRed">Geef een geldige tijd op.</td>
</tr>
</table>
</div>';
...
<table cellspacing="1" cellpadding="2" class="mnavWarnTbl">
<tr>
	<td class="GenTextRed">The periode die u hebt opgegeven is groter dan door de beheerder is toegestaan. Probeer een kleinere periode.</td>
</tr>
</table>
</div>';
...
<table cellspacing="0" cellpadding="0" class="ContentTable">';
		while ($r = db_rowobj($c)) {
			...
			if ($oldt != $r->thread_id) {
				$mnav_data .= '<tr><th class="RowStyleC">&nbsp;&nbsp;&nbsp;</th><th colspan="2"> Onderwerp: <a class="thLnk" href="index.php?t='.d_thread_view.'&amp;goto='.$r->id.'&amp;'._rsid.'#msg_'.$r->id.'">'.$r->subject.'</a></th></tr>';
				$oldt = $r->thread_id;
			}
			$mnav_data .= '<tr>
	...
	<td>
		...
		<tr class="mnavH">
			...
			<td class="TopBy wa ac">Geplaatst door: '.(!empty($r->poster_id) ? '<a href="index.php?t=usrinfo&amp;id='.$r->poster_id.'&amp;'._rsid.'">'.$r->alias.'</a>' : $GLOBALS['ANON_NICK'].'' ) .'</td>
			<td class="DateText nw ar">'.strftime('%a, %d %B %Y %H:%M', $r->post_stamp).'</td>
		</tr>
		<tr class="mnavM SmallText">
			<td colspan="3">'.trim_body(read_msg_body($r->foff, $r->length, $r->file_id)).' <a href="index.php?t='.d_thread_view.'&amp;goto='.$r->id.'&amp;'._rsid.'#msg_'.$r->id.'">Meer &raquo;&raquo;</a></td>
		</tr>
		</table>
	</td>
</tr>';
		...
		if (!$total) {
			$mnav_data = '<div class="GenText mnavNoRes ac"><p>Er zijn geen resultaten voor uw zoekopdracht.</p></div>';
		} else {
			$mnav_data .= '</table>
</div>';
...
<tr>
	<th colspan="4" class="wa">Berichtennavigatie</th>
</tr>
<tr class="<?php echo alt_var('color_alt','RowStyleA','RowStyleB'); ?>">
	<td class="GenText nw" width="30%">Periode:</td>
	<td class="GenText SmallText">nieuwer dan<br /><input tabindex="1" type="text" name="rng" value="<?php echo $rng; ?>" maxlength="10" size="11" /></td>
	<td class="GenText SmallText">ouder dan<br /><input tabindex="2" type="text" name="rng2" value="<?php echo $rng2; ?>" maxlength="10" size="11" /></td>
	<td class="al vb" width="60%"><select name="u" tabindex="3"><?php echo $mnav_time_unit; ?></select></td></tr>
<tr class="<?php echo alt_var('color_alt','RowStyleA','RowStyleB'); ?>">
	<td class="GenText nw">Alleen zoeken in:</td>
	<td colspan="3" class="vt">
		<select name="forum_limiter" tabindex="4"><option value="">Alle forums doorzoeken</option>
...
<tr class="'.alt_var('color_alt','RowStyleA','RowStyleB').'">
	<td class="GenText nw">Alleen zoeken in geabonneerde forums</td>
	<td colspan="3" class="vt"><input type="checkbox" name="sub" value="1" '.($subl ? 'checked="checked" ' : '' )  .' /></td>
' : ''); ?>
<tr class="RowStyleC">
	<td class="GenText ar" colspan="4"><input type="submit" tabindex="5" class="button" name="btn_submit" value="Zoeken" /></td>
</tr>
</table></form>
<br />
<?php echo $mnav_data; ?>
