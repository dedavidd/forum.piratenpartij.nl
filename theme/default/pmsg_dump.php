...
* $Id: pmsg_dump.php.t 5324 2011-07-15 14:04:17Z naudefj $
*
...
<tr>
	<td class="MsgR1 al vt"><b>Onderwerp:</b> '.$obj->subject.'</td>
	<td class="MsgR1 ar vt DateText"><b>Door:</b> '.$obj->alias.' <b>op</b> '.strftime('%a, %d %B %Y %H:%M', $obj->post_stamp).'</td>
</tr>
<tr>
...
<body>
	<div class="content">
		<h1>Privéberichten voor <?php echo $usr->alias; ?></h1>
		<?php echo $pm_data; ?>
		<small>Geëxporteerd: <?php echo strftime('%a %b %#d %H:%M:%S %Z %Y', __request_timestamp__); ?></small>
	</div>
</body>
</html>