...
* $Id: movemsg.php.t 5221 2011-04-22 11:30:48Z naudefj $
*
...
if (_uid) {
	...
	<td class="RowStyleA">
		...
		<tr class="RowStyleB">
			<td class="SmallText">
				<b>Bericht van:</b> '.($r->alias ? $r->alias.'' : $anon_alias.'' )  .'<br />
				<b>Geplaatst op:</b> '.strftime('%a, %d %B %Y %H:%M', $r->post_stamp).'<br />
				<b>Onderwerp:</b> '.$r->subject.'
			</td>
		</tr>
		<tr class="RowStyleA">
...
<table cellspacing="1" cellpadding="2" class="ContentTable">
<tr>
	<th class="wa" colspan="2">Beheervenster voor het splisen van onderwerpen</th>
</tr>
<tr class="RowStyleA">
	<td class="al fb">Geef het nummer van het doelonderwerp (kan zich in een ander forum bevinden)</td>
	<td class="al"><input type="text" value="" name="dest_th" /></td>
</tr>
<tr class="RowStyleC">
	<td colspan="2" class="ac"><input type="submit" class="button" name="btn_selected" value="Geselecteerde berichten verplaatsen" /></td>
</tr>
</table>
<br />
<table cellspacing="1" cellpadding="2" class="ContentTable">
<tr>
	<th class="nw">Selecteren</th><th width="100%">Berichten</th>
</tr>
<?php echo $msg_entry; ?>
</table>
<br />
