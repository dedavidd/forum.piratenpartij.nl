...
* $Id: split_th.php.t 5221 2011-04-22 11:30:48Z naudefj $
*
...
<tr class="RowStyleA">
	<td class="al fb">Nieuwe naam onderwerp:</td>
...
<tr class="RowStyleC">
	<td colspan="2" class="ac">
		<input type="submit" class="button" name="btn_selected" value="Geselecteerde berichten splitsen" />
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="submit" class="button" name="btn_unselected" value="Niet-geselecteerde berichten splitsen" />
	</td>
</tr>
</table>
<br />
<table cellspacing="1" cellpadding="2" class="ContentTable">
<tr>
	<th class="nw">Selecteren</th>
	<th width="100%">Berichten</th>
</tr>
<?php echo $msg_entry; ?>
</table>
<br />
