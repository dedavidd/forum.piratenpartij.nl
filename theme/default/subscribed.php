...
<tr class="RowStyleC">
	...
	<td class="ar"><input type="submit" class="button" name="f_unsub_all" value="Abbonement van alle forums opheffen" /></td>
</tr>
' : '
...
<tr class="RowStyleC">
	...
	<td class="ar"><input type="submit" class="button" name="t_unsub_all" value="Abbonement van alle onderwerpen opheffen" /></td>
</tr>
' : '
<tr class="'.alt_var('search_alt','RowStyleA','RowStyleB').'">
