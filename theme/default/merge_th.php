...
* $Id: merge_th.php.t 5221 2011-04-22 11:30:48Z naudefj $
*
...
<tr>
	<th class="wa" colspan="2">Beheerscherm onderwerp samenvoegen</th>
</tr>
<?php echo (isset($new_th) ? '<tr  class="RowStyleA">
	<td colspan="2" class="al"><b>Naar het <a href="index.php?t=msg&amp;'._rsid.'&amp;th='.$new_th.'">laatst samengevoegde onderwerp</a> gaan of een ander onderwerp samenvoegen:</b></td>
</tr>' : ''); ?>
<tr class="RowStyleA">
	<td class="al"><b>Nieuwe naam onderwerp:</b></td>
...
<tr class="RowStyleC">
	<td colspan="2" class="ac">
		<table border="0" cellspacing="1" cellpadding="2">
			<tr><td colspan="3" class="ac">Selecteer samen te voegen onderwerpen <span class="SmallText">(u moet meerdere onderwerpen selecteren)</span></td></tr>
			<tr><td colspan="3" class="ac">Onderwerppaginaselectie: 
			...
			<tr>
				<td class="al" width="100">
					<?php echo ($page > 1 ? '<input type="submit" name="prev" value="Vorige onderwerpen" />' : ''); ?>
				</td>
				<td class="ac" width="200"><input type="submit" name="merge" value="Geselecteerde onderwerpen samenvoegen" /></td>
				<td class="ar" width="100">
					<?php echo ($page < $max_p ? '<input type="submit" name="next" value="Volgende onderwerpen" />' : ''); ?>
				</td>
			</tr>
		</table>
	</td>
