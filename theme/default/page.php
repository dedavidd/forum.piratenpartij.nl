...
* $Id: page.php.t 5324 2011-07-15 14:04:17Z naudefj $
*
...
ses_update_status($usr->sid, 'Pagina aan het bekijken');
...
<div class="breadcrumbs">
	<a href="index.php?t=i&amp;<?php echo _rsid; ?>">Startpagina</a> &nbsp;&raquo;
	<?php echo (empty($page) ? '
		Beschikbare pagina&#39;s
	' : '
		'.($page->page_opt&2 ? '
			<a href="index.php?t=page&amp;'._rsid.'">Beschikbare pagina&#39;s</a> &nbsp;&raquo; '.$page->title.'
		' : '
			'.$page->title.'
		' )  .'
	'); ?>
...
' : '
	...
	<i>'.convertPlural($i, array(''.$i.' weergegeven pagina',''.$i.' weergegeven pagina&#39;s')).'.</i>
'); ?>
</div>
