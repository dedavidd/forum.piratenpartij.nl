...
<tr class="'.alt_var('search_alt','RowStyleA','RowStyleB').'">
	<td colspan="2" class="GenText ar"><input type="submit" class="button" name="submit" value="Geselecteerde toevoegen" /></td>
</tr>' : '<tr class="RowStyleA">
	<td class="GenText ac">Geen vrienden om uit te kiezen</td>
</tr>'); ?>
</table>
</form>
</div>
