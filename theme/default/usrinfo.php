...
/* Print number of unread private messages in User Control Panel. */
	...
	$TITLE_EXTRA = ': Ledeninformatie '.$u->alias;
...
<td>
<a href="'.$GLOBALS['WWW_ROOT'].'adm/admuser.php?usr_id='.$u->id.'&amp;S='.s.'&amp;act=1&amp;SQ='.$GLOBALS['sq'].'">Wijzigen</a> || <a href="'.$GLOBALS['WWW_ROOT'].'adm/admuser.php?usr_id='.$u->id.'&amp;S='.s.'&amp;act=del&amp;SQ='.$GLOBALS['sq'].'">Verwijderen</a> || 
'.($u->users_opt & 65536 ? '
