...
function th_reply_rebuild($forum_id, $th, $sticky)
{
	...
	while ($r = db_rowarr($c)) {
		$table_data .= '<tr>
	<td>'.$r[0].'</td><td>'.$r[1].'</td>
	<td><a href="index.php?t=ratingtrack&amp;th='.$th.'&amp;ratingid='.$r[2].'&amp;'._rsid.'&amp;SQ='.$GLOBALS['sq'].'">Verwijderen</a></td>
</tr>';
	}
	unset($c);
...
<tr>
	<td class="small" colspan="3">Waardering beheren voor het onderwerp <b><?php echo $thr->subject; ?></b>:</td>
</tr>
<tr>
...
<?php echo $table_data; ?>
<tr>
	<td class="ac RowStyleC" colspan="3">[<a href="javascript://" onclick="window.close();">Venster sluiten</a>]</td>
</tr>
</table>
</div>
</body></html>
