...
if (_uid === '_uid') {
	...
	switch ($section) {
		...
		case 'boardusage':
		case 'readingposting':
			$file = '/srv/smf.piratenpartij.nl/theme/default/help/'. $section .'.hlp';
			$return_top = '<div class="GenText ac">[ <a href="index.php?t=help_index&amp;'._rsid.'">Terug naar hulpindex</a> ]</div>';
			break;
		default:
			$file = '/srv/smf.piratenpartij.nl/theme/default/help/faq_index.hlp';
			$return_top = '';
	}

	ses_update_status($usr->sid, 'De <a href="index.php?t=help_index">F.A.Q.</a> lezen');
	$TITLE_EXTRA = ': Hulp';
