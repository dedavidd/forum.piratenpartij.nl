...
* $Id: coppa.php.t 5497 2012-05-27 08:32:58Z naudefj $
*
...
<tr>
	<th>COPPA-bevestiging</th>
</tr>
<tr class="RowStyleA GenText ac">
	<td>
		Klik op de verwijzing die overeenstemt met uw leeftijd<br /><br />
		[<a href="index.php?t=pre_reg&amp;coppa=&amp;<?php echo _rsid; ?>">Voor <?php echo strftime('%B %#d, %Y', $coppa); ?></a>]&nbsp;
		[<a href="index.php?t=pre_reg&amp;coppa=1&amp;<?php echo _rsid; ?>">Na <?php echo strftime('%B %#d, %Y', $coppa); ?></a>]
		<hr/>
		Een ouder of voogd moet via fax of post een getekend toestemmingsformulier verzenden naar de beheerder van dit forum voordat een gebruiker <b>jonger dan 13</b> de registratie kan voltooien.</p><p>Voor meer informatie kunt u contact opnemen met <a href="mailto:<?php echo $GLOBALS['ADMIN_EMAIL']; ?>"><?php echo $GLOBALS['ADMIN_EMAIL']; ?></a></p>.
	</td>
</tr>
</table>
</div>
